...
{headers['rec']}: A decisive stance supported by the most convincing arguments.
{headers['rationale']}: An explanation of why these arguments lead to your conclusion.
{headers['strategic_actions']}: Concrete steps for implementing the recommendation.
